"use strict";Object.defineProperty(exports, "__esModule", {value: true});const fs = typeof window !== "undefined" ? null : eval('require("node:fs")');
const ReadStream = fs ? fs.ReadStream : null;
 ...
 function extractFiles(value, path = "", isExtractableFileMethod = isExtractableFile) {
