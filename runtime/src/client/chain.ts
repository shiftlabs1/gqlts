interface Chain {
    ...
    const wrapInProxy = (chain: Chain, onExecute: (path: string[], request: any, defaultValue: any,config:any) => any): any =>
      new Proxy(chain, {
        get(target, prop) {
    ...
    export const chain = (onExecute: (path: string[], request: any, defaultValue: any,config?:any) => any) =>
